...
class Sixroyalpage extends StatefulWidget {
  const Sixroyalpage({Key? key}) : super(key: key);

  @override
  State<Sixroyalpage> createState() => _SixroyalpageState();
}

class _SixroyalpageState extends State<Sixroyalpage> {
  @override
