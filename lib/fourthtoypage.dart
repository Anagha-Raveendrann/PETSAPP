...
class fourthtoypage extends StatefulWidget {
  const fourthtoypage({Key? key}) : super(key: key);

  @override
  State<fourthtoypage> createState() => _fourthtoypageState();
}

class _fourthtoypageState extends State<fourthtoypage> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Column(
              children: [
                Image.asset('asset/dogtoyballl.jpg',width: 350,),
              ],
            ),
            SizedBox(
              height: 30,
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text("Colour Balls",style: TextStyle(fontSize: 20),),
                ],
              ),
            ),
            SizedBox(
            ...
            Row(
              children: [
                ...
                ),Icon(Icons.currency_rupee),Text("999")
              ],
            ),
            SizedBox(
              height: 10,
