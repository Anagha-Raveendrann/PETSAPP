...
class Arrivalone extends StatefulWidget {
  const Arrivalone({Key? key}) : super(key: key);

  @override
  State<Arrivalone> createState() => _ArrivaloneState();
}

class _ArrivaloneState extends State<Arrivalone> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Column(
              children: [
                Image.asset('asset/Dog_Raincoat-removebg-preview.png',width: 350,),
              ],
            ),
            SizedBox(
              height: 30,
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text("RainCoat",style: TextStyle(fontSize: 20),),
                ],
              ),
            ),
            SizedBox(
