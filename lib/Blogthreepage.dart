...
class Blogthree extends StatefulWidget {
  const Blogthree({Key? key}) : super(key: key);

  @override
  State<Blogthree> createState() => _BlogthreeState();
}

class _BlogthreeState extends State<Blogthree> {
  @override
                  ...
                  children: [
                    Padding(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: (){}, child: Text("CATS",style: TextStyle(color: Colors.white),),),
                    ),
                    SizedBox(
                      width: 6,
                    ),
                    ...
                    ElevatedButton(
                        style: ElevatedButton.styleFrom(backgroundColor: Colors.green),
                        onPressed: (){}, child: Text("DOGS",style: TextStyle(color: Colors.white),)),
                ...
                Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text('Can you Feed "Human food" to your dog?',style: TextStyle(fontSize: 25),),
                    ),
                    Padding(
                      padding: const EdgeInsets.only(right: 260.0),
                      child: Text("13/06/2023"),
                    )
                  ],
                ),
                Image.asset('asset/blogthreepage.jpg'),
                Padding(
