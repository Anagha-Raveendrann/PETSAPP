...
class Eighttoypage extends StatefulWidget {
  const Eighttoypage({Key? key}) : super(key: key);

  @override
  State<Eighttoypage> createState() => _EighttoypageState();
}

class _EighttoypageState extends State<Eighttoypage> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Column(
              children: [
                Image.asset('asset/dooooocaatt1.webp',width: 350,),
              ],
            ),
            SizedBox(
              height: 30,
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text("Chew Dog Toy",style: TextStyle(fontSize: 20),),
                ],
              ),
            ),
            SizedBox(
            ...
            Row(
              children: [
                ...
                ),Icon(Icons.currency_rupee),Text("666")
              ],
            ),
            SizedBox(
              height: 10,
