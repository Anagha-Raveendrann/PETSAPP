...
class Sevenroyalpage extends StatefulWidget {
  const Sevenroyalpage({Key? key}) : super(key: key);

  @override
  State<Sevenroyalpage> createState() => _SevenroyalpageState();
}

class _SevenroyalpageState extends State<Sevenroyalpage> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Column(
              children: [
                Image.asset('asset/royal7.jpg',width: 300,),
              ],
            ),
            SizedBox(
              height: 30,
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text("Ageing 12+ wet food",style: TextStyle(fontSize: 20),),
                ],
              ),
            ),
            SizedBox(
