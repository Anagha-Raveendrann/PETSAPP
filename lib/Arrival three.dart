...
class Arrivalthree extends StatefulWidget {
  const Arrivalthree({Key? key}) : super(key: key);

  @override
  State<Arrivalthree> createState() => _ArrivalthreeState();
}

class _ArrivalthreeState extends State<Arrivalthree> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Column(
              children: [
                Image.asset('asset/redraincoat-removebg-preview.png',width: 350,),
              ],
            ),
            SizedBox(
              height: 30,
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text("Redcolour Raincot",style: TextStyle(fontSize: 20),),
                ],
              ),
            ),
            SizedBox(
