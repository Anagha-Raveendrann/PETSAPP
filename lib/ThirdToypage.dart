...
class Thirdtoypage extends StatefulWidget {
  const Thirdtoypage({Key? key}) : super(key: key);

  @override
  State<Thirdtoypage> createState() => _ThirdtoypageState();
}

class _ThirdtoypageState extends State<Thirdtoypage> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Column(
              children: [
                Image.asset('asset/togball.jpg',width: 350,),
              ],
            ),
            SizedBox(
              height: 30,
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text("Puppy Ball",style: TextStyle(fontSize: 20),),
                ],
              ),
            ),
            SizedBox(
