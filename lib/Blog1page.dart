...
class Blogonee extends StatefulWidget {
  const Blogonee({Key? key}) : super(key: key);

  @override
  State<Blogonee> createState() => _BlogoneeState();
}

class _BlogoneeState extends State<Blogonee> {
  @override
          ...
          children: [
            Column(
              children: [
                ...
                Image.asset('asset/blog1homepage.jpg'),
                Padding(
