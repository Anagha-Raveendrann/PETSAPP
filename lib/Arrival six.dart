...
class Arrivalsix extends StatefulWidget {
  const Arrivalsix({Key? key}) : super(key: key);

  @override
  State<Arrivalsix> createState() => _ArrivalsixState();
}

class _ArrivalsixState extends State<Arrivalsix> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Column(
              children: [
                Image.asset('asset/puppyyyy.jpg',width: 350,),
              ],
            ),
            SizedBox(
              height: 30,
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text("Whitecolour Raincoat",style: TextStyle(fontSize: 20),),
                ],
              ),
            ),
            SizedBox(
