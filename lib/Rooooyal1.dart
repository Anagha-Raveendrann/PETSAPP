...
class firstroyalpage extends StatefulWidget {
  const firstroyalpage({Key? key}) : super(key: key);

  @override
  State<firstroyalpage> createState() => _firstroyalpageState();
}

class _firstroyalpageState extends State<firstroyalpage> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Column(
              children: [
                Image.asset('asset/royal1.jpg',width: 300,),
              ],
            ),
            SizedBox(
              height: 30,
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text("Royal Canin coon",style: TextStyle(fontSize: 20),),
                ],
              ),
            ),
            SizedBox(
