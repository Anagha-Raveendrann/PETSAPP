...
class Clothone extends StatefulWidget {
  const Clothone({Key? key}) : super(key: key);

  @override
  State<Clothone> createState() => _ClothoneState();
}

class _ClothoneState extends State<Clothone> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Column(
              children: [
                Image.asset('asset/Dog_Raincoat-removebg-preview.png',width: 300,),
              ],
            ),
            SizedBox(
              height: 30,
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text("Rugby coat",style: TextStyle(fontSize: 20),),
                ],
              ),
            ),
            SizedBox(
