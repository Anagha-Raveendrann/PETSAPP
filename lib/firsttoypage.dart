          ...
          class firsttoypage extends StatefulWidget {
            const firsttoypage({Key? key}) : super(key: key);

            @override
            State<firsttoypage> createState() => _firsttoypageState();
          }

          class _firsttoypageState extends State<firsttoypage> {
            @override
                ...
                body: SingleChildScrollView(
                  child: Column(
                    children: [
                      Column(
                        children: [
                          Image.asset('asset/dogpottas.jpg',width: 300,),
                        ],
                      ),
                      SizedBox(
                        height: 30,
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Text("Rugby Ball",style: TextStyle(fontSize: 20),),
                          ],
                        ),
                      ),
                      SizedBox(
