...
class Arrivalfour extends StatefulWidget {
  const Arrivalfour({Key? key}) : super(key: key);

  @override
  State<Arrivalfour> createState() => _ArrivalfourState();
}

class _ArrivalfourState extends State<Arrivalfour> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Column(
              children: [
                Image.asset('asset/whiskasneww-removebg-preview (1).png',width: 350,),
              ],
            ),
            SizedBox(
              height: 30,
