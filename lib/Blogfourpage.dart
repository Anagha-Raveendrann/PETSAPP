...
class Blogfour extends StatefulWidget {
  const Blogfour({Key? key}) : super(key: key);

  @override
  State<Blogfour> createState() => _BlogfourState();
}

class _BlogfourState extends State<Blogfour> {
  @override
          ...
          children: [
            Column(
              children: [
                ...
                Image.asset('asset/blogfourpage.jpg'),
                Padding(
