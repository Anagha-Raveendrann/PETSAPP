...
class thirdroyalpage extends StatefulWidget {
  const thirdroyalpage({Key? key}) : super(key: key);

  @override
  State<thirdroyalpage> createState() => _thirdroyalpageState();
}

class _thirdroyalpageState extends State<thirdroyalpage> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Column(
              children: [
                Image.asset('asset/royal3.jpg',width: 300,),
              ],
            ),
            SizedBox(
              height: 30,
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text("Baby Dog Milk",style: TextStyle(fontSize: 20),),
                ],
              ),
            ),
            SizedBox(
