...
class Lasttoypage extends StatefulWidget {
  const Lasttoypage({Key? key}) : super(key: key);

  @override
  State<Lasttoypage> createState() => _LasttoypageState();
}

class _LasttoypageState extends State<Lasttoypage> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Column(
              children: [
                Image.asset('asset/plush5-removebg-preview.png'),
              ],
            ),
            SizedBox(
              height: 30,
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text("Barkbutler Lulu The Lioness",style: TextStyle(fontSize: 20),),
                ],
              ),
            ),
            SizedBox(
