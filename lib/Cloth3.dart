...
class Cloththird extends StatefulWidget {
  const Cloththird({Key? key}) : super(key: key);

  @override
  State<Cloththird> createState() => _CloththirdState();
}

class _CloththirdState extends State<Cloththird> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Column(
              children: [
                Image.asset('asset/cloathing-removebg-preview.png',width: 300,),
              ],
            ),
            SizedBox(
              height: 30,
