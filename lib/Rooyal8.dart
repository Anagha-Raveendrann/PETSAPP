...
class Eightroyalfood extends StatefulWidget {
  const Eightroyalfood({Key? key}) : super(key: key);

  @override
  State<Eightroyalfood> createState() => _EightroyalfoodState();
}

class _EightroyalfoodState extends State<Eightroyalfood> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Column(
              children: [
                Image.asset('asset/royal8.jpg',width: 300,),
              ],
            ),
            SizedBox(
              height: 30,
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text("Adult dog food combo",style: TextStyle(fontSize: 20),),
                ],
              ),
            ),
            SizedBox(
