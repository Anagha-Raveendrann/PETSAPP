...
class Arrivaltwo extends StatefulWidget {
  const Arrivaltwo({Key? key}) : super(key: key);

  @override
  State<Arrivaltwo> createState() => _ArrivaltwoState();
}

class _ArrivaltwoState extends State<Arrivaltwo> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Column(
              children: [
                Image.asset('asset/leg_raincoat-removebg-preview.png',width: 350,),
              ],
            ),
            SizedBox(
              height: 30,
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text("LegRaincot",style: TextStyle(fontSize: 20),),
                ],
              ),
            ),
            SizedBox(
