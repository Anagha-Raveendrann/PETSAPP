...
class Groomthree extends StatefulWidget {
  const Groomthree({Key? key}) : super(key: key);

  @override
  State<Groomthree> createState() => _GroomthreeState();
}

class _GroomthreeState extends State<Groomthree> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Column(
              children: [
                Image.asset('asset/grrom cleaning brush.jpg',width: 300,),
              ],
            ),
            SizedBox(
              height: 30,
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text("Cleaning Brush",style: TextStyle(fontSize: 20),),
                ],
              ),
            ),
            SizedBox(
