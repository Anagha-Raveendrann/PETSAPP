...
class Ninetoypage extends StatefulWidget {
  const Ninetoypage({Key? key}) : super(key: key);

  @override
  State<Ninetoypage> createState() => _NinetoypageState();
}

class _NinetoypageState extends State<Ninetoypage> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Column(
              children: [
                Image.asset('asset/plush6-removebg-preview.png',width: 350,),
              ],
            ),
            SizedBox(
              height: 30,
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text("Plush Toy",style: TextStyle(fontSize: 20),),
                ],
              ),
            ),
            SizedBox(
            ...
            Row(
              children: [
                ...
                ),Icon(Icons.currency_rupee),Text("899")
              ],
            ),
            SizedBox(
              height: 10,
