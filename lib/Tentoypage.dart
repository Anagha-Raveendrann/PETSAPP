...
class Tentoypage extends StatefulWidget {
  const Tentoypage({Key? key}) : super(key: key);

  @override
  State<Tentoypage> createState() => _TentoypageState();
}

class _TentoypageState extends State<Tentoypage> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Column(
              children: [
                Image.asset('asset/dogtoyballl.jpg',width: 130,),
              ],
            ),
            SizedBox(
              height: 30,
