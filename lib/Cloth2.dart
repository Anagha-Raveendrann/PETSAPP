...
class Clothtwo extends StatefulWidget {
  const Clothtwo({Key? key}) : super(key: key);

  @override
  State<Clothtwo> createState() => _ClothtwoState();
}

class _ClothtwoState extends State<Clothtwo> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Column(
              children: [
                Image.asset('asset/leg_raincoat-removebg-preview.png',width: 300,),
              ],
            ),
            SizedBox(
              height: 30,
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text("White coat",style: TextStyle(fontSize: 20),),
                ],
              ),
            ),
            SizedBox(
