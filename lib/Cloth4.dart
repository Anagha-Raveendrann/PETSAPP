...
class Clothfour extends StatefulWidget {
  const Clothfour({Key? key}) : super(key: key);

  @override
  State<Clothfour> createState() => _ClothfourState();
}

class _ClothfourState extends State<Clothfour> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Column(
              children: [
                Image.asset('asset/redraincoat-removebg-preview.png',width: 300,),
              ],
            ),
            SizedBox(
              height: 30,
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text("Dog fullbody coat",style: TextStyle(fontSize: 20),),
                ],
              ),
            ),
            SizedBox(
