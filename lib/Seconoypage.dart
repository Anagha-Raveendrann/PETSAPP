...
class Seconftoypag extends StatefulWidget {
  const Seconftoypag({Key? key}) : super(key: key);

  @override
  State<Seconftoypag> createState() => _SeconftoypagState();
}

class _SeconftoypagState extends State<Seconftoypag> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Column(
              children: [
                Image.asset('asset/toyspage.jpg',width: 350,),
              ],
            ),
            SizedBox(
              height: 30,
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text("Hen Toy",style: TextStyle(fontSize: 20),),
                ],
              ),
            ),
            SizedBox(
