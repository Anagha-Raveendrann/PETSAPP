...
class Fiveroyalpage extends StatefulWidget {
  const Fiveroyalpage({Key? key}) : super(key: key);

  @override
  State<Fiveroyalpage> createState() => _FiveroyalpageState();
}

class _FiveroyalpageState extends State<Fiveroyalpage> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Column(
              children: [
                Image.asset('asset/royal5.jpg',width: 300,),
              ],
            ),
            SizedBox(
              height: 30,
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text("Nutrition Adult Dry food",style: TextStyle(fontSize: 20),),
                ],
              ),
            ),
            SizedBox(
