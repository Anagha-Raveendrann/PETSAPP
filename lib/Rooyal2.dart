...
class Secondroyalpage extends StatefulWidget {
  const Secondroyalpage({Key? key}) : super(key: key);

  @override
  State<Secondroyalpage> createState() => _SecondroyalpageState();
}

class _SecondroyalpageState extends State<Secondroyalpage> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Column(
              children: [
                Image.asset('asset/royal2.jpg',width: 300,),
              ],
            ),
            SizedBox(
              height: 30,
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text("Beauty wet food",style: TextStyle(fontSize: 20),),
                ],
              ),
            ),
            SizedBox(
