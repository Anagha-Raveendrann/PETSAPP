...
class Groomone extends StatefulWidget {
  const Groomone({Key? key}) : super(key: key);

  @override
  State<Groomone> createState() => _GroomoneState();
}

class _GroomoneState extends State<Groomone> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Column(
              children: [
                Image.asset('asset/groom.jpg',width: 300,),
              ],
            ),
            SizedBox(
              height: 30,
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text("Groom Brush",style: TextStyle(fontSize: 20),),
                ],
              ),
            ),
            SizedBox(
