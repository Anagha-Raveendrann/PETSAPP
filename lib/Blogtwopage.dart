...
class Blogtwoo extends StatefulWidget {
  const Blogtwoo({Key? key}) : super(key: key);

  @override
  State<Blogtwoo> createState() => _BlogtwooState();
}

class _BlogtwooState extends State<Blogtwoo> {
  @override
          ...
          children: [
            Column(
              children: [
                ...
                Image.asset('asset/blogtwopage.jpg'),
                Padding(
